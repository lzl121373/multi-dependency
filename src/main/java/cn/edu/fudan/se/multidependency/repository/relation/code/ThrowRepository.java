...
public interface ThrowRepository extends Neo4jRepository<Throw, Long> {
	...
	@Query("MATCH result=(function:Function)-[:" + RelationType.str_THROW + "]->(type:Type) with function,type,result match (project:Project)-[:" + RelationType.str_CONTAIN + "*3..4]->(type) where id(project)=$projectId RETURN result")
